...
describe VCSToolkit::Objects::Object do
  ...
  context 'with fresh named instance' do
    subject(:object) { described_class.new id: :custom_object_id, named: true }

    it 'has an id reader' do
      expect(object.id).to eq :custom_object_id
    end
  ...
  context 'with fresh nameless instance' do
    subject(:object) do
      described_class.new id:               :object_id_hash,
                          verify_object_id: false
    end

    it 'has an id reader' do
      expect(object.id).to eq :object_id_hash
    end
  ...
  it 'should equal other objects with the same id' do
    object_one = described_class.new id:               :object_id_one,
                                     verify_object_id: false

    object_two = described_class.new id:               :object_id_one,
                                     verify_object_id: false
  ...
  it 'should not equal objects with different id' do
    object_one = described_class.new id:               :object_id_one,
                                     verify_object_id: false

    object_two = described_class.new id:               :object_id_two,
                                     verify_object_id: false
